...
def _calculate_cart_summary(cart: Cart) -> dict:
    ...
    for item in cart.items:
        ...
        items_data.append({
            ...
            "category_name1": item.product.category_name1,
            "category_name2": item.product.category_name2,
            "category_name3": item.product.category_name3,
            "is_essential": item.product.is_essential,
            "total_sold": item.product.total_sold,
            "price_tier_global": item.product.price_tier_global,
            "price_tier_category": item.product.price_tier_category,
            "necessity_auto": item.product.necessity_auto,
            "necessity_final": item.product.necessity_final,
